...
const Home = () => {
    ...
    return (
        <Wrapper>
            ...
            <HeroImage src={ProductCarousel} alt="Carousel featuring Recipe Cards of the starter recipes"/>
            <Slogan>
            Welcome to <ItalicSpan>My Cooking Manager</ItalicSpan>, the place to help you organize your online recipes!
            </Slogan>
            <ActionContainer>
                ...
                <ActionButton onClick={() => navigate("/recipes")}>Browse your Recipe Collection</ActionButton> 
            </ActionContainer>
        </Wrapper>
    )
