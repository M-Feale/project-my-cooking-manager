...
const RecipeCollection = () => {
	...
	// 	let endpoint;
	// 	if (searchTerms) {
	// 		// endpoint = value of endpoint determined by what the BE expects for a searchTerms search
	// 	} else if (category) {
	// 		// endpoint = value of endpoint determined by what the BE expects for a category search
	// 	} else {
	// 		// endpoint = value of endpoint determined by what the BE expects for a "all recipes" search
	// 	}
